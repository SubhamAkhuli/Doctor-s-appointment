...
<body>
    ...
    $insertdate="";
    $searchtype="My Bookings ";
    $m = "";
 if($_POST){
     if(!empty($_POST["scheduledate"])){
         $scheduledate=$_POST["scheduledate"];
         $sqlmain= "select appointment.appoid,schedule.scheduleid,schedule.title,doctor.docname,patient.pname,schedule.scheduledate,schedule.scheduletime,appointment.apponum,appointment.appodate from schedule inner join appointment on schedule.scheduleid=appointment.scheduleid inner join patient on patient.pid=appointment.pid inner join doctor on schedule.docid=doctor.docid  where  patient.pid=$userid and schedule.scheduledate='$scheduledate'";
         $insertdate= date('d-m-Y', strtotime($_POST["scheduledate"]));
         $searchtype="My Bookings on "; 
         $m = '"';
    ...
    $sqlmain="select appointment.appoid,schedule.scheduleid,schedule.title,doctor.docname,patient.pname,schedule.scheduledate,schedule.scheduletime,appointment.apponum,appointment.appodate from schedule inner join appointment on schedule.scheduleid=appointment.scheduleid inner join patient on patient.pid=appointment.pid inner join doctor on schedule.docid=doctor.docid  where  patient.pid=$userid and schedule.scheduledate>='$today' order by appointment.appodate  asc";
    $result = mysqli_query($database, $sqlmain);
 }
    ...
    <div class="dash-body">
                                ...
                                <td width="30%">
                                    <form action="" method="post">
                                        ...
                                        <input type="date" name="scheduledate" id="date"
                                            class="input-text filter-container-items"<?php 
                                            echo'min="'.$today.'"';
            ...
            <tr>
                <td colspan="4" style="padding-top:10px;width: 100%;">
                    <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">
                        <?php echo $searchtype.$m.$insertdate.$m ."(".$result->num_rows.")"; ?> </p>
                </td>
                                ...
                                if($result->num_rows==0){
                                    ...
                                    for ( $x=0; $x<($result->num_rows);$x++){
                                        ...
                                        for($q=0;$q<3;$q++){
                                            ...
                                            $apponum=$row["apponum"];
                                            $appodate = date('d-m-Y', strtotime($row["appodate"]));
                                            $appoid=$row["appoid"];
                                            ...
                                            <td style="width: 25%;">
                                                    <div  class="dashboard-items search-items"  >
                                                        ...
                                                        <div class="h3-search">
                                                                ...
                                                                <div class="h4-search">
                                                                    Scheduled Date: '.$scheduledate.'<br>Starts at: <b>'.$scheduletime.'</b>
                                                                </div>
                                                                <br>
        ...
        <?php
            if($_GET){
                ...
                $id=$_GET["id"];
                $list11 = $database->query("select  * from  patient where pid= $id;");
                ...
                <div id="popup1" class="overlay">
                        ...
                        <br><br>
                            ...
                            <a class="close" href="appointment.php">&times;</a>
                            <div class="content" >
                            '.$name.' Your Appointment booked Successfull<br><br>
                            </div>
                            <div style="display: flex;justify-content: center;">

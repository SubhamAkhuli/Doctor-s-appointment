                    ...
                    <tr>
                        <td >
                            ...
                            <form action="schedule.php" method="post" style="display: flex">
                                ...
                                <input type="search" name="search" class="input-text " placeholder="Search By the Doctor's name or Session name " style="width:45%;">&nbsp;&nbsp;                  
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                                ...
                                                if($result->num_rows==0){
                                                    ...
                                                    <a class="non-style-link" href="schedule.php"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Channel to a Doctor &nbsp;</font></button>
                                                    </a>
                                                    </center>
                                                    <br><br><br><br>
                                                    </td>

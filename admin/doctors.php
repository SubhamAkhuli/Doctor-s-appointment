...
?> -->
                ...
                <td colspan="4" >
                        ...
                        <div class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49);margin-top: 5px;">Add New Doctor</div>
                    ...
                    <div id="popup1" class="overlay">
                            ...
                            <center>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                        <input type="email" name="newemail" class="input-text" placeholder="Email Address" value="'.$email.'" required><br>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <select name="spec" id="" class="box">;
                                            <option value=""style="display:none"selected>Choose one</option><br/>';
                                            // echo "<option value=".$spcil_id.">$spcil_name</option><br/>";

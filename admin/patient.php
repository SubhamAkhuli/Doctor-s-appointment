                 ...
                 $searchtype="All Doctors";
                         if($_POST){
                             ...
                             $result = mysqli_query($database, $sqlmain);
                                ...
                                $sqlmain= "select * from patient order by pid asc";
                             $insertkey=$keyword;
                             $result = mysqli_query($database, $sqlmain);
                         }
                         }
                ...
                ?>
                    ...
                    <td>
                        ...
                        <form action="" method="post" class="header-search">
                            ...
                            <input type="search" name="search" class="input-text header-searchbar" placeholder="Search Patient name or Email" value="<?php  echo $insertkey ?>">&nbsp;&nbsp;

...
<body>
    ...
    <?php       
                    ...
                    //         $sqlmain1= "select pid from patient where pemail='$keyword' or pname='$keyword' or pname like '$keyword%' or pname like '%$keyword' or pname like '%$keyword%' ";
                    //         $result1= mysqli_query($database,$sqlmain1);
                    //         $find1= $result1->fetch_assoc();
                    //         $find = $find1["pid"];
                    //         // echo var_dump($find1);

                    //         // echo $find;
                    //         $sqlmain = "select * from appointment inner join patient on patient.pid=appointment.pid inner join schedule on schedule.scheduleid=appointment.scheduleid where schedule.docid=$userid and  appointment.pid = '$find'";
                    //         // $selecttype="my";
                    //     }
                    //     else if ($_POST["search12"]==""){
            ...
            <tr>
                <td colspan="4" style="padding-top:10px;">
                    <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">
                        <?php echo " My Patients (".$result->num_rows.")"; ?></p>
                </td>
                            ...
                            <tbody>
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr>
                                        ...
                                        <td style="padding-top:19px;display:flex;justify-content: center;">
                                        '.substr($email,0,30).'
                                         </td>
                                        <td>
                                        '.$dob.'

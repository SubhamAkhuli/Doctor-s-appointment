        ...
        if($action=='drop'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <div class="content">
                            You want to delete this record<br>('.$nameget.').
                    ...
                    <div id="popup1" class="overlay">
                            ...
                            <center>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td>
                                            <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Edit Your Account Details. <br><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            ...
                                            <option value=""style="display:none"selected>Choose one</option><br/>';
                                            // echo "<option value=".$id00.">$spcil_name</option><br/>";  
                                            // <option value='.$id00.'style="display:none" selected>'.$spcil_name.'</option>
                                                ...
                                                for ($y=0;$y<$list11->num_rows;$y++){
                                                    ...
                                                    $sn=$row00["sname"];
                                                    $id00=$row00["id"];
                                                //    echo "<option value='.$id00.'style='display:none' selected>$spcil_name</option><br/>";
